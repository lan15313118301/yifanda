...
<link rel="stylesheet" href="/Public/jst_htadmin/css/colorpicker.css" />
<link rel="stylesheet" href="/Public/jst_htadmin/css/ace.min.css" id="main-ace-style" />
<script src="/Public/jst_htadmin/js/area.js"></script>
...
$(function(){
	 $("#class1").change(function(){	 
		 ...
		 //alert($lbtitle);
		 $.getJSON('<?php echo U("jst_htadmin/tourism/class2");?>',{lbtitle:$lbtitle},function(data){
		 if (data.status==1){
...
<div class="main-container" id="main-container"> 
  ...
  <ul class="nav nav-list" style="top: 0px;">
    ...
    <li <?php if(CONTROLLER_NAME == 'Banner'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jst_htadmin/banner/index");?>"> <i class="menu-icon fa fa-tachometer"></i> <span class="menu-text"> banner图 </span> </a> <b class="arrow"></b>
    </li>
    ...
    <ul class="submenu">
      <li <?php if($showid == '1' && $type == '1') echo "class='active'"; ?>><a href="<?php echo U("jst_htadmin/show/index?id=1");?>"><i class="menu-icon fa fa-caret-right"></i>公司简介</a><b class="arrow"></b>
      </li>
      <li <?php if($showid == '2' && $type == '1') echo "class='active'"; ?>><a href="<?php echo U("jst_htadmin/show/index?id=2");?>"><i class="menu-icon fa fa-caret-right"></i>企业理念</a><b class="arrow"></b>
      </li>
      <li <?php if(CONTROLLER_NAME == 'Honor') echo "class='active'"; ?>><a href="<?php echo U("jst_htadmin/honor/index");?>"><i class="menu-icon fa fa-caret-right"></i>荣誉资质</a><b class="arrow"></b>
      </li>
    </ul>
    </li>
    ...
    <ul class="submenu">
      <li <?php if(CONTROLLER_NAME == 'News' && $type == '1') echo "class='active'"; ?>><a href="<?php echo U("jst_htadmin/news/index?type=1");?>"><i class="menu-icon fa fa-caret-right"></i>媒体报道</a><b class="arrow"></b>
      </li>
      <li <?php if(CONTROLLER_NAME == 'News' && $type == '2') echo "class='active'"; ?>><a href="<?php echo U("jst_htadmin/news/index?type=2");?>"><i class="menu-icon fa fa-caret-right"></i>行业动态</a><b class="arrow"></b>
      </li>
      <li <?php if(CONTROLLER_NAME == 'News' && $type == '3') echo "class='active'"; ?>><a href="<?php echo U("jst_htadmin/news/index?type=3");?>"><i class="menu-icon fa fa-caret-right"></i>公司动态</a><b class="arrow"></b>
      </li>
    </ul>
    </li>
    ...
    <ul class="submenu">
      <li <?php if(CONTROLLER_NAME == 'Product' && $type == '1') echo "class='active'"; ?>><a href="<?php echo U("jst_htadmin/product/index?type=1");?>"><i class="menu-icon fa fa-caret-right"></i>ELCOA.0.</a><b class="arrow"></b>
      </li>
      <li <?php if(CONTROLLER_NAME == 'Product' && $type == '2') echo "class='active'"; ?>><a href="<?php echo U("jst_htadmin/product/index?type=2");?>"><i class="menu-icon fa fa-caret-right"></i>史密斯</a><b class="arrow"></b>
      </li>
    </ul>
    </li>
    <li <?php if(CONTROLLER_NAME == 'Support'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jst_htadmin/support/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 技术支持 </span> </a> <b class="arrow"></b></li>
    <li <?php if(CONTROLLER_NAME == 'Show' && $type == '2'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jst_htadmin/show/index?id=3");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 服务流程 </span> </a> <b class="arrow"></b></li>
    <li <?php if(CONTROLLER_NAME == 'Project'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jst_htadmin/project/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 工程业绩 </span> </a> <b class="arrow"></b></li>
    
    <li <?php if(CONTROLLER_NAME == 'Case'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jst_htadmin/case/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 案例展示 </span> </a> <b class="arrow"></b></li>
    <li <?php if(CONTROLLER_NAME == 'Cooperative'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jst_htadmin/cooperative/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 合作伙伴 </span> </a> <b class="arrow"></b></li>
    <li <?php if(CONTROLLER_NAME == 'Enroll'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jst_htadmin/enroll/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 免费预约 </span> </a> <b class="arrow"></b></li>
  </ul>
    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 旅游服务 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 修改 </small> </h1>
        </div>
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="col-xs-10 col-sm-5" name="name" value="<?php echo ($list["name"]); ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  ...
                  <span id="thumbshow"><?php if($list["thumb"] != ''): ?><img src="<?php echo ($list[thumb]); ?>" style="max-width:200px;max-height:200px;"><?php endif; ?></span> <span id="thumberror"></span> 
                  <script src="/Public/jst_htadmin/js/jquery-1.7.1.min.js"></script> 
                  <script type="text/javascript" src="/Public/jst_htadmin/js/ajaxupload.3.6.js" ></script>
                  <input id="thumbbutton" class="btn btn-xs" type="button" value="重新上传" />
                  (尺寸 300*225) 
                  <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        new AjaxUpload('thumbbutton', { action : "<?php echo U('jst_htadmin/upload/upload?type=thumb');?>",//请求目标
                                                            name : 'upload', //文件参数名
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Jst_htadmin/Tourism/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
              ...
              <div class="space-4"></div>
              <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> 属性 : </label>
                <div class="col-sm-9">
                  <label class="pull-left" style="margin-top:4px; margin-right:10px"> <input type="checkbox" value="1" name="sales" class="ace" <?php if($list["sales"] == 1): ?>checked="checked"<?php endif; ?> /> <span class="lbl"> 限时特价 </span> </label>
                  <label class="pull-left" style="margin-top:4px"> <input type="checkbox" value="1" name="recommend" class="ace" <?php if($list["recommend"] == 1): ?>checked="checked"<?php endif; ?> /> <span class="lbl"> 热门推荐 </span> </label>
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <link rel="stylesheet" href="/Public/jst_htadmin/kindeditor-4.1.10/themes/default/default.css" />
                  <link rel="stylesheet" href="/Public/jst_htadmin/kindeditor-4.1.10/plugins/code/prettify.css" />
                  <script charset="utf-8" src="/Public/jst_htadmin/kindeditor-4.1.10/kindeditor.js"></script> 
                  <script charset="utf-8" src="/Public/jst_htadmin/kindeditor-4.1.10/lang/zh_CN.js"></script> 
                  <script charset="utf-8" src="/Public/jst_htadmin/kindeditor-4.1.10/plugins/code/prettify.js"></script>
                  <style>
                  ...
                  <script>
                                                    KindEditor.ready(function(K) {
                                                            var editor1 = K.create('textarea[name="content[]"]', {
                                                                    cssPath : '/Public/jst_htadmin/kindeditor-4.1.10/plugins/code/prettify.css',
                //                                                    uploadJson : '/Public/jst_htadmin/kindeditor-4.1.10/php/upload_json.php',
                                                                    uploadJson : '<?php echo U("jst_htadmin/upload/uploadphoto?type=thumb");?>',
                                                                    fileManagerJson : '<?php echo U("jst_htadmin/upload/mannex");?>',
                  ...
                  <textarea name="content[]" class="col-xs-10 col-sm-9" style="min-width:700px;height:300px;visibility:hidden;"><?php echo ($list["content"]["0"]); ?></textarea>
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> 经典介绍 : </label>
                <div class="col-sm-9">
                  <textarea name="content[]" class="col-xs-10 col-sm-9" style="min-width:700px;height:300px;visibility:hidden;"><?php echo ($list["content"]["1"]); ?></textarea>
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> 交通指南 : </label>
                <div class="col-sm-9">
                  <textarea name="content[]" class="col-xs-10 col-sm-9" style="min-width:700px;height:300px;visibility:hidden;"><?php echo ($list["content"]["2"]); ?></textarea>
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> 温馨提示 : </label>
                <div class="col-sm-9">
                  <textarea name="content[]" class="col-xs-10 col-sm-9" style="min-width:700px;height:300px;visibility:hidden;"><?php echo ($list["content"]["3"]); ?></textarea>
                </div>
              </div>
...
<!--[if lte IE 8]>
		  <script src="/Public/jst_htadmin/js/excanvas.min.js"></script>
		<![endif]--> 
<script src="/Public/jst_htadmin/js/jquery-ui.custom.min.js"></script> 
<script src="/Public/jst_htadmin/js/jquery.ui.touch-punch.min.js"></script> 
<script src="/Public/jst_htadmin/js/chosen.jquery.min.js"></script> 
<script src="/Public/jst_htadmin/js/fuelux/fuelux.spinner.min.js"></script> 
<script src="/Public/jst_htadmin/js/date-time/bootstrap-datepicker.min.js"></script> 
<script src="/Public/jst_htadmin/js/date-time/bootstrap-timepicker.min.js"></script> 
<script src="/Public/jst_htadmin/js/date-time/moment.min.js"></script> 
<script src="/Public/jst_htadmin/js/date-time/daterangepicker.min.js"></script> 
<script src="/Public/jst_htadmin/js/date-time/bootstrap-datetimepicker.min.js"></script> 
<script src="/Public/jst_htadmin/js/bootstrap-colorpicker.min.js"></script> 
<script src="/Public/jst_htadmin/js/jquery.knob.min.js"></script> 
<script src="/Public/jst_htadmin/js/jquery.autosize.min.js"></script> 
<script src="/Public/jst_htadmin/js/jquery.inputlimiter.1.3.1.min.js"></script> 
<script src="/Public/jst_htadmin/js/jquery.maskedinput.min.js"></script> 
<script src="/Public/jst_htadmin/js/bootstrap-tag.min.js"></script> 
<script src="/Public/jst_htadmin/js/typeahead.jquery.min.js"></script> 
...
<script type="text/javascript">
			jQuery(function($) {
				...
				$(".input-mask-tourism").mask("a*-999-a999",{placeholder:" ",completed:function(){alert("You typed the following: "+this.val());}});
				...
				$('#id-file-format').removeAttr('checked').on('change', function() {
					...
					.on('file.error.ace', function(e, info) {
						...
						*/
						...
						//on any tourism you still should check files with your server side script
				...
				//this way select element becomes visible with dimensions and chosen tourism as expected
