...
$(function(){
	 $("#class1").change(function(){	 
		 ...
		 //alert($lbtitle);
		 $.getJSON('<?php echo U("df_htadmin/project/class2");?>',{lbtitle:$lbtitle},function(data){
		 if (data.status==1){
    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 工程业绩 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 添加 </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="<?php echo U("df_htadmin/project/add");?>" method="post" enctype="multipart/form-data">
                  ...
                  <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Df_htadmin/Project/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
              ...
              <div class="space-4"></div>
              <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 使用型号 : </label>
                <div class="col-sm-9">
                  <input type="text" class="col-xs-10 col-sm-5" name="xinghao" value="<?php echo ($list["xinghao"]); ?>" />
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 用水情况 : </label>
                <div class="col-sm-9">
                  <input type="text" class="col-xs-10 col-sm-5" name="qingkuang" value="<?php echo ($list["qingkuang"]); ?>" />
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="col-xs-10 col-sm-5" name="beizhu" value="<?php echo ($list["beizhu"]); ?>" />
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
...
<script type="text/javascript">
			jQuery(function($) {
				...
				$(".input-mask-project").mask("a*-999-a999",{placeholder:" ",completed:function(){alert("You typed the following: "+this.val());}});
				...
				$('#id-file-format').removeAttr('checked').on('change', function() {
					...
					.on('file.error.ace', function(e, info) {
						...
						*/
						...
						//on any project you still should check files with your server side script
				...
				try{
					...
					//display a textarea for old IE, because it doesn't project this plugin or another one I tried!
				...
				//this way select element becomes visible with dimensions and chosen project as expected
