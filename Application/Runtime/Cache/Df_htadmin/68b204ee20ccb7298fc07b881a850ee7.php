...
$(function(){
	 $("#class1").change(function(){	 
		 ...
		 //alert($lbtitle);
		 $.getJSON('<?php echo U("df_htadmin/honor/class2");?>',{lbtitle:$lbtitle},function(data){
		 if (data.status==1){
    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 荣誉资质 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 修改 </small> </h1>
        </div>
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
                  ...
                  <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Df_htadmin/Honor/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
