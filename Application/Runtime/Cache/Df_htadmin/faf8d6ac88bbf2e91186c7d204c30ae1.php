...
<link rel="stylesheet" href="/Public/df_htadmin/css/colorpicker.css" />
<link rel="stylesheet" href="/Public/df_htadmin/css/ace.min.css" id="main-ace-style" />
<script src="/Public/df_htadmin/js/area.js"></script>
...
$(function(){
	 $("#class1").change(function(){	 
		 ...
		 //alert($lbtitle);
		 $.getJSON('<?php echo U("df_htadmin/product/class2");?>',{lbtitle:$lbtitle},function(data){
		 if (data.status==1){
    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 产品介绍 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 修改 </small> </h1>
        </div>
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                  ...
                  <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Df_htadmin/Product/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="col-xs-10 col-sm-9" name="leixing" value="<?php echo ($list["leixing"]); ?>" />
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="col-xs-10 col-sm-9" name="bianhao" value="<?php echo ($list["bianhao"]); ?>" />
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 产品规格 : </label>
                <div class="col-sm-9">
                  <input type="text" class="col-xs-10 col-sm-9" name="guige" value="<?php echo ($list["guige"]); ?>" />
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 备　　注 : </label>
                <div class="col-sm-9">
                  <input type="text" class="col-xs-10 col-sm-9" name="beizhu" value="<?php echo ($list["beizhu"]); ?>" />
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> 性能特点 : </label>
                <div class="col-sm-9">
              ...
              <div class="space-4"></div>
              <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> 结构原理 : </label>
                <div class="col-sm-9">
                  <script>
                                                    KindEditor.ready(function(K) {
                                                            var editor1 = K.create('textarea[name="content[]"]', {
              ...
              <div class="space-4"></div>
              <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> 应用范围 : </label>
                <div class="col-sm-9">
