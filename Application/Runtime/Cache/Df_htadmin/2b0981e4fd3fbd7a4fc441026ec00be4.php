...
$(function(){
	 $("#class1").change(function(){	 
		 ...
		 //alert($lbtitle);
		 $.getJSON('<?php echo U("df_htadmin/school/class2");?>',{lbtitle:$lbtitle},function(data){
		 if (data.status==1){
...
<div class="main-container" id="main-container"> 
  ...
  <ul class="nav nav-list" style="top: 0px;">
    ...
    <li class="<?php if(CONTROLLER_NAME == 'Show' && $type == '1' || CONTROLLER_NAME == 'Event'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 关于我们 </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
    <ul class="submenu">
      ...
      <li <?php if($showid == '2' && $type == '1') echo "class='active'"; ?>><a href="<?php echo U("df_htadmin/show/index?id=2");?>"><i class="menu-icon fa fa-caret-right"></i>唐城优势</a><b class="arrow"></b>
      </li>
      <li <?php if(CONTROLLER_NAME == 'Teacher') echo "class='active'"; ?>><a href="<?php echo U("df_htadmin/teacher/index");?>"><i class="menu-icon fa fa-caret-right"></i>师资力量</a><b class="arrow"></b>
      </li>
      <li class="hsub <?php if(CONTROLLER_NAME == 'School'): ?>active open<?php endif; ?>"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-caret-right"></i> 校园环境 <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
      <ul class="submenu">
        <li <?php if(CONTROLLER_NAME == 'School' && $type == '1'): ?>class="active"<?php endif; ?>> <a href="<?php echo U('df_htadmin/school/index?type=1');?>"> 南校区 </a> <b class="arrow"></b>
        </li>
        <li <?php if(CONTROLLER_NAME == 'School' && $type == '2'): ?>class="active"<?php endif; ?>> <a href="<?php echo U('df_htadmin/school/index?type=2');?>"> 北校区 </a> <b class="arrow"></b>
        </li>
      </ul>
      </li>
    </ul>
    ...
    <li class="<?php if(CONTROLLER_NAME == 'News'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 校园快讯 </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
    <ul class="submenu">
      <li <?php if(CONTROLLER_NAME == 'News' && $type == '1') echo "class='active'"; ?>><a href="<?php echo U("df_htadmin/news/index?type=1");?>"><i class="menu-icon fa fa-caret-right"></i>学校新闻</a><b class="arrow"></b>
      </li>
      <li <?php if(CONTROLLER_NAME == 'News' && $type == '2') echo "class='active'"; ?>><a href="<?php echo U("df_htadmin/news/index?type=2");?>"><i class="menu-icon fa fa-caret-right"></i>行业新闻</a><b class="arrow"></b>
      </li>
      <li <?php if(CONTROLLER_NAME == 'News' && $type == '3') echo "class='active'"; ?>><a href="<?php echo U("df_htadmin/news/index?type=3");?>"><i class="menu-icon fa fa-caret-right"></i>求职技巧</a><b class="arrow"></b>
      </li>
      <li <?php if(CONTROLLER_NAME == 'News' && $type == '4') echo "class='active'"; ?>><a href="<?php echo U("df_htadmin/news/index?type=4");?>"><i class="menu-icon fa fa-caret-right"></i>招生问答</a><b class="arrow"></b>
      </li>
    </ul>
    </li>
    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 校园环境 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 添加 </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="<?php echo U("df_htadmin/school/add");?>" method="post" enctype="multipart/form-data">
                  ...
                  <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Df_htadmin/School/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
...
<script type="text/javascript">
			jQuery(function($) {
				...
				$(".input-mask-school").mask("a*-999-a999",{placeholder:" ",completed:function(){alert("You typed the following: "+this.val());}});
				...
				$('#id-file-format').removeAttr('checked').on('change', function() {
					...
					.on('file.error.ace', function(e, info) {
						...
						*/
						...
						//on any school you still should check files with your server side script
				...
				//this way select element becomes visible with dimensions and chosen school as expected
