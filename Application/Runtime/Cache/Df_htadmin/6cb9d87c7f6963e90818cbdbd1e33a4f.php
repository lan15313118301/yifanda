    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="row">
          <div class="col-xs-12">
            <div class="row">
            <form action="<?php echo U('cooperative/dels');?>" method="post" id="myform">
              ...
              <div class="col-xs-12">
                ...
                <div class="well well-sm">
                  ...
                  <a class='menubutton' href='<?php echo U("df_htadmin/cooperative/add?type=".$type."");?>'> 添加数据 <i class="fa fa-external-link bigger-110"></i> </a> </div>
                  ...
                  <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><div class="hidden-sm hidden-xs action-buttons"> 
                            ...
                            <a class="green" href="<?php echo U("df_htadmin/cooperative/edit?id=".$v['id']."&type=".$type."");?>"> <i class="ace-icon fa fa-pencil bigger-130"></i> </a> 
                            <a class="red" href="<?php echo U("df_htadmin/cooperative/del?id=".$v['id']."");?>" onclick="if (confirm('确认删除吗？')){return true;}else{return false;}"> <i class="ace-icon fa fa-trash-o bigger-130"></i> </a> </div></td>
                    ...
                    <tr>
                        <td class="right" colspan="8">
                            ...
                            <input type="submit" class="btn btn-info" value="保存排序" onClick="$('#myform').attr('action', '<?php echo U("cooperative/sort");?>'); ">
                        </td>
                      </tr>
                  </table>
                </div>
