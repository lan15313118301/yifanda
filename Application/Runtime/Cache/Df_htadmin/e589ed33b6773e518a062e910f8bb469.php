				...
				<div class="page-content">
					<div class="page-content-area">
                        ...
                        <?php if($showid == 1): ?><div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo U("df_htadmin/show/index");?>" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="col-sm-9"> 
                                    <script>
                                        KindEditor.ready(function(K) {
                                            ...
                                            uploadJson : '<?php echo U("df_htadmin/show/uploadphoto?type=thumb");?>',
                                            fileManagerJson : '/Df_htadmin/Show/mannex/',
