...
<link rel="stylesheet" href="/Public/jqg_htadmin/css/colorpicker.css" />
<link rel="stylesheet" href="/Public/jqg_htadmin/css/ace.min.css" id="main-ace-style" />
<script src="/Public/jqg_htadmin/js/area.js"></script>
...
$(function(){
	 $("#class1").change(function(){	 
		 ...
		 //alert($lbtitle);
		 $.getJSON('<?php echo U("jqg_htadmin/video/class2");?>',{lbtitle:$lbtitle},function(data){
		 if (data.status==1){
...
<div class="main-container" id="main-container"> 
  ...
  <ul class="nav nav-list" style="top: 0px;">
    <li <?php if(CONTROLLER_NAME == 'Index'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jqg_htadmin/index/index");?>"> <i class="menu-icon fa fa-tachometer"></i> <span class="menu-text"> 控制台 </span> </a> <b class="arrow"></b>
    </li>
    ...
    <ul class="submenu">
      <li <?php if($type == '1') echo "class='active'"; ?>><a href="<?php echo U("jqg_htadmin/healthy/index?type=1");?>"><i class="menu-icon fa fa-caret-right"></i>护鼻</a><b class="arrow"></b>
      <li <?php if($type == '2') echo "class='active'"; ?>><a href="<?php echo U("jqg_htadmin/healthy/index?type=2");?>"><i class="menu-icon fa fa-caret-right"></i>爱眼</a><b class="arrow"></b>
      </li>
    </ul>
    </li>  
    ...
    <ul class="submenu">
      <li <?php if(CONTROLLER_NAME == 'Product' && $type==1) echo "class='active'"; ?>><a href="<?php echo U("jqg_htadmin/product/index?type=1");?>"><i class="menu-icon fa fa-caret-right"></i>护鼻冲洗器</a><b class="arrow"></b>
      </li>
      <li <?php if(CONTROLLER_NAME == 'Product' && $type==2) echo "class='active'"; ?>><a href="<?php echo U("jqg_htadmin/product/index?type=2");?>"><i class="menu-icon fa fa-caret-right"></i>隐形眼镜冲洗器</a><b class="arrow"></b>
      </li>
    </ul>
    ...
    <ul class="submenu">
      <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '2') echo "class='active'"; ?>><a href="<?php echo U("jqg_htadmin/show/index?id=2");?>"><i class="menu-icon fa fa-caret-right"></i>社会责任</a><b class="arrow"></b>
      </li>
      <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '3') echo "class='active'"; ?>><a href="<?php echo U("jqg_htadmin/show/index?id=3");?>"><i class="menu-icon fa fa-caret-right"></i>技术创新</a><b class="arrow"></b>
      </li>
      <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '4') echo "class='active'"; ?>><a href="<?php echo U("jqg_htadmin/show/index?id=4");?>"><i class="menu-icon fa fa-caret-right"></i>管理创新</a><b class="arrow"></b>
      </li>
    </ul>
    </li>
    ...
    <ul class="submenu">
      <li <?php if(CONTROLLER_NAME == 'Service') echo "class='active'"; ?>><a href="<?php echo U("jqg_htadmin/service/index");?>"><i class="menu-icon fa fa-caret-right"></i>常见问题</a><b class="arrow"></b></li>
      <li <?php if(CONTROLLER_NAME == 'Information') echo "class='active'"; ?>><a href="<?php echo U("jqg_htadmin/information/index");?>"><i class="menu-icon fa fa-caret-right"></i>信息通告</a><b class="arrow"></b></li>
      <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '5') echo "class='active'"; ?>><a href="<?php echo U("jqg_htadmin/show/index?id=5");?>"><i class="menu-icon fa fa-caret-right"></i>服务热线</a><b class="arrow"></b></li>
    </ul>
    </li>
    
    
    <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '6' ): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jqg_htadmin/show/index?id=6");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 联系我们 </span> </a> <b class="arrow"></b></li>
    <li <?php if(CONTROLLER_NAME == 'Joinus'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jqg_htadmin/joinus/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 加入我们 </span> </a> <b class="arrow"></b></li>
    <li <?php if(CONTROLLER_NAME == 'News'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jqg_htadmin/news/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 新闻资讯 </span> </a> <b class="arrow"></b></li>

    <li <?php if(CONTROLLER_NAME == 'Feedback'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jqg_htadmin/feedback/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 意见反馈 </span> </a> <b class="arrow"></b></li>
    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 视频中心 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 修改 </small> </h1>
        </div>
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
                  ...
                  <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Jqg_htadmin/Video/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
...
<script type="text/javascript">
			jQuery(function($) {
				...
				$(".input-mask-video").mask("a*-999-a999",{placeholder:" ",completed:function(){alert("You typed the following: "+this.val());}});
				...
				$('#id-file-format').removeAttr('checked').on('change', function() {
					...
					.on('file.error.ace', function(e, info) {
						...
						*/
						...
						//on any video you still should check files with your server side script
				...
				//this way select element becomes visible with dimensions and chosen video as expected
