...
<link rel="stylesheet" href="/Public/jqg_htadmin/css/jquery-ui.custom.min.css" />
  ...
  <div class="col-xs-12"> 
    <!-- PAGE CONTENT BEGINS -->
    <form class="form-horizontal" role="form" action="<?php echo U("jqg_htadmin/show/index");?>" method="post" enctype="multipart/form-data">
                  ...
                  <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Jqg_htadmin/Show/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
        ...
        <div class="col-sm-9"> 
          <script>
                                        KindEditor.ready(function(K) {
                                            ...
                                            uploadJson : '<?php echo U("jqg_htadmin/show/uploadphoto?type=thumb");?>',
                                            fileManagerJson : '/Jqg_htadmin/Show/mannex/',
