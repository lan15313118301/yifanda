...
$(function(){
	 $("#class1").change(function(){	 
		 ...
		 //alert($lbtitle);
		 $.getJSON('<?php echo U("jqg_htadmin/furnituretype/class2");?>',{lbtitle:$lbtitle},function(data){
		 if (data.status==1){
...
<div class="main-container" id="main-container"> 
  ...
  <ul class="nav nav-list" style="top: 0px;">
    ...
    <ul class="submenu">
      <li <?php if(CONTROLLER_NAME == 'Service') echo "class='active'"; ?>><a href="<?php echo U("jqg_htadmin/service/index");?>"><i class="menu-icon fa fa-caret-right"></i>常见问题</a><b class="arrow"></b>
      </li>
      <li <?php if(CONTROLLER_NAME == 'Information') echo "class='active'"; ?>><a href="<?php echo U("jqg_htadmin/information/index");?>"><i class="menu-icon fa fa-caret-right"></i>信息通告</a><b class="arrow"></b>
      </li>
    ...
    <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '6' ): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jqg_htadmin/show/index?id=6");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 联系我们 </span> </a> <b class="arrow"></b>
    </li>
    <li <?php if(CONTROLLER_NAME == 'Joinus'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jqg_htadmin/joinus/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 加入我们 </span> </a> <b class="arrow"></b>
    </li>
    <li <?php if(CONTROLLER_NAME == 'News'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jqg_htadmin/news/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 新闻资讯 </span> </a> <b class="arrow"></b>
    </li>
    <li <?php if(CONTROLLER_NAME == 'Feedback'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jqg_htadmin/feedback/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 意见反馈 </span> </a> <b class="arrow"></b>
    </li>
  </ul>
    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 清明家具-栏目管理 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 修改 </small> </h1>
        </div>
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
                  ...
                  <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Jqg_htadmin/Furnituretype/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
...
<script type="text/javascript">
			jQuery(function($) {
				...
				$(".input-mask-furnituretype").mask("a*-999-a999",{placeholder:" ",completed:function(){alert("You typed the following: "+this.val());}});
				...
				$('#id-file-format').removeAttr('checked').on('change', function() {
					...
					.on('file.error.ace', function(e, info) {
						...
						*/
						...
						//on any furnituretype you still should check files with your server side script
				...
				//this way select element becomes visible with dimensions and chosen furnituretype as expected
