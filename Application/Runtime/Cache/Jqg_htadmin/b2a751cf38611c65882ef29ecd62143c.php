    ...
    <div class="page-content">
      <div class="page-content-area">
        ...
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="<?php echo U("jqg_htadmin/news/add");?>" method="post" enctype="multipart/form-data">
						...
						if(ext && /^(jpg|jpeg|png|gif)$/.test(ext)){
							...
							$("#thumbbutton").attr("disabled","disabled");
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Jqg_htadmin/News/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
