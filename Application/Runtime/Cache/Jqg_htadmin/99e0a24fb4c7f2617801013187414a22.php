...
$(function(){
	 $("#class1").change(function(){	 
		 ...
		 //alert($lbtitle);
		 $.getJSON('<?php echo U("jqg_htadmin/interlocution/class2");?>',{lbtitle:$lbtitle},function(data){
		 if (data.status==1){
    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 百问百答 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 修改 </small> </h1>
        </div>
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
...
<script type="text/javascript">
			jQuery(function($) {
				...
				$(".input-mask-interlocution").mask("a*-999-a999",{placeholder:" ",completed:function(){alert("You typed the following: "+this.val());}});
				...
				$('#id-file-format').removeAttr('checked').on('change', function() {
					...
					.on('file.error.ace', function(e, info) {
						...
						*/
						...
						//on any interlocution you still should check files with your server side script
				...
				//this way select element becomes visible with dimensions and chosen interlocution as expected
