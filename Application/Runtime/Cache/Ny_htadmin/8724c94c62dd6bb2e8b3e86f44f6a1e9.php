...
<div class="main-container" id="main-container"> 
  ...
  <ul class="nav nav-list" style="top: 0px;">
    ...
    <li <?php if(CONTROLLER_NAME == 'Photovoltaic'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("ny_htadmin/photovoltaic/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 光伏产业 </span> </a> <b class="arrow"></b></li>
    <li <?php if(CONTROLLER_NAME == 'Wind'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("ny_htadmin/wind/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 风电产业 </span> </a> <b class="arrow"></b></li>
    <li <?php if(CONTROLLER_NAME == 'Power'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("ny_htadmin/power/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 电力服务 </span> </a> <b class="arrow"></b></li>
    ...
    <li class="<?php if(CONTROLLER_NAME == 'Product'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 产品展示 </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
        <ul class="submenu">
          <li <?php if(CONTROLLER_NAME == 'Product' && $type == '1') echo "class='active'"; ?>><a href="<?php echo U("ny_htadmin/product/index?type=1");?>"><i class="menu-icon fa fa-caret-right"></i>柔性饰面砖</a><b class="arrow"></b>
          </li>
          <li <?php if(CONTROLLER_NAME == 'Product' && $type == '2') echo "class='active'"; ?>><a href="<?php echo U("ny_htadmin/product/index?type=2");?>"><i class="menu-icon fa fa-caret-right"></i>天然彩色装饰砂浆</a><b class="arrow"></b>
          </li>
          <li <?php if(CONTROLLER_NAME == 'Product' && $type == '3') echo "class='active'"; ?>><a href="<?php echo U("ny_htadmin/product/index?type=3");?>"><i class="menu-icon fa fa-caret-right"></i>外墙外保温</a><b class="arrow"></b>
          </li>
    ...
    <li class="<?php if(CONTROLLER_NAME == 'Case'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 工程案例 </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
        <ul class="submenu">
          <li <?php if(CONTROLLER_NAME == 'Case' && $type == '1') echo "class='active'"; ?>><a href="<?php echo U("ny_htadmin/case/index?type=1");?>"><i class="menu-icon fa fa-caret-right"></i>柔性饰面砖</a><b class="arrow"></b>
          </li>
          <li <?php if(CONTROLLER_NAME == 'Case' && $type == '2') echo "class='active'"; ?>><a href="<?php echo U("ny_htadmin/case/index?type=2");?>"><i class="menu-icon fa fa-caret-right"></i>天然彩色装饰砂浆</a><b class="arrow"></b>
          </li>
          <li <?php if(CONTROLLER_NAME == 'Case' && $type == '3') echo "class='active'"; ?>><a href="<?php echo U("ny_htadmin/case/index?type=3");?>"><i class="menu-icon fa fa-caret-right"></i>外墙外保温</a><b class="arrow"></b>
          </li>
          
        </ul>
    </li>
    <li <?php if(CONTROLLER_NAME == 'Technical'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("ny_htadmin/technical/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 技术解答 </span> </a> <b class="arrow"></b></li>
    <li <?php if(CONTROLLER_NAME == 'Patent'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("ny_htadmin/patent/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 专利标准 </span> </a> <b class="arrow"></b></li>
    ...
    <li class="<?php if(CONTROLLER_NAME == 'News'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 动态信息 </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
        <ul class="submenu">
          <li <?php if(CONTROLLER_NAME == 'News' && $type == '1') echo "class='active'"; ?>><a href="<?php echo U("ny_htadmin/news/index?type=1");?>"><i class="menu-icon fa fa-caret-right"></i>企业动态</a><b class="arrow"></b>
          </li>
          <li <?php if(CONTROLLER_NAME == 'News' && $type == '2') echo "class='active'"; ?>><a href="<?php echo U("ny_htadmin/news/index?type=2");?>"><i class="menu-icon fa fa-caret-right"></i>行业动态</a><b class="arrow"></b>
          </li>
          <li <?php if(CONTROLLER_NAME == 'News' && $type == '3') echo "class='active'"; ?>><a href="<?php echo U("ny_htadmin/news/index?type=3");?>"><i class="menu-icon fa fa-caret-right"></i>视频播报</a><b class="arrow"></b>
          </li>
          
        </ul>
    </li>
    
    <li <?php if(CONTROLLER_NAME == 'Show' && $type == '1'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("ny_htadmin/show/index?id=1");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 关于我们 </span> </a> <b class="arrow"></b></li>
    <li <?php if(CONTROLLER_NAME == 'Show' && $type == '2'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("ny_htadmin/show/index?id=2");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 联系我们 </span> </a> <b class="arrow"></b></li>
    <li <?php if(CONTROLLER_NAME == 'Clients'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("ny_htadmin/clients/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 合作客户 </span> </a> <b class="arrow"></b></li>
    <li <?php if(CONTROLLER_NAME == 'Online'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("ny_htadmin/online/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 在线加盟 </span> </a> <b class="arrow"></b></li>
    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 社会责任 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 添加 </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="<?php echo U("ny_htadmin/social/add");?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  ...
                  <script src="/Public/ny_htadmin/js/jquery-1.7.1.min.js"></script> 
                  <script type="text/javascript" src="/Public/ny_htadmin/js/ajaxupload.3.6.js" ></script>
                  <input id="thumbbutton" class="btn btn-xs" type="button" value="上传" />
                  (尺寸 276*204) 
                  <script type="text/javascript">
					$(document).ready(function() {
						new AjaxUpload('thumbbutton', { action : "<?php echo U('ny_htadmin/upload/upload?type=thumb');?>",//请求目标
						name : 'upload', //文件参数名
						...
						if(ext && /^(jpg|jpeg|png|gif)$/.test(ext)){
							...
							$("#thumbbutton").attr("disabled","disabled");
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Ny_htadmin/Social/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <link rel="stylesheet" href="/Public/ny_htadmin/kindeditor-4.1.10/themes/default/default.css" />
                  <link rel="stylesheet" href="/Public/ny_htadmin/kindeditor-4.1.10/plugins/code/prettify.css" />
                  <script charset="utf-8" src="/Public/ny_htadmin/kindeditor-4.1.10/kindeditor.js"></script> 
                  <script charset="utf-8" src="/Public/ny_htadmin/kindeditor-4.1.10/lang/zh_CN.js"></script> 
                  <script charset="utf-8" src="/Public/ny_htadmin/kindeditor-4.1.10/plugins/code/prettify.js"></script>
                  <style>
                  ...
                  <script>
                                                    KindEditor.ready(function(K) {
                                                            var editor1 = K.create('textarea[name="content"]', {
                                                                    cssPath : '/Public/ny_htadmin/kindeditor-4.1.10/plugins/code/prettify.css',
                //                                                    uploadJson : '/Public/ny_htadmin/kindeditor-4.1.10/php/upload_json.php',
                                                                    uploadJson : '<?php echo U("ny_htadmin/upload/uploadphoto?type=thumb");?>',
                                                                    fileManagerJson : '<?php echo U("ny_htadmin/upload/mannex");?>',
...
<!--[if lte IE 8]>
		  <script src="/Public/ny_htadmin/js/excanvas.min.js"></script>
		<![endif]--> 
<script src="/Public/ny_htadmin/js/jquery-ui.custom.min.js"></script> 
<script src="/Public/ny_htadmin/js/jquery.ui.touch-punch.min.js"></script> 
<script src="/Public/ny_htadmin/js/chosen.jquery.min.js"></script> 
<script src="/Public/ny_htadmin/js/fuelux/fuelux.spinner.min.js"></script> 
<script src="/Public/ny_htadmin/js/date-time/bootstrap-datepicker.min.js"></script> 
<script src="/Public/ny_htadmin/js/date-time/bootstrap-timepicker.min.js"></script> 
<script src="/Public/ny_htadmin/js/date-time/moment.min.js"></script> 
<script src="/Public/ny_htadmin/js/date-time/daterangepicker.min.js"></script> 
<script src="/Public/ny_htadmin/js/date-time/bootstrap-datetimepicker.min.js"></script> 
<script src="/Public/ny_htadmin/js/bootstrap-colorpicker.min.js"></script> 
<script src="/Public/ny_htadmin/js/jquery.knob.min.js"></script> 
<script src="/Public/ny_htadmin/js/jquery.autosize.min.js"></script> 
<script src="/Public/ny_htadmin/js/jquery.inputlimiter.1.3.1.min.js"></script> 
<script src="/Public/ny_htadmin/js/jquery.maskedinput.min.js"></script> 
<script src="/Public/ny_htadmin/js/bootstrap-tag.min.js"></script> 
<script src="/Public/ny_htadmin/js/typeahead.jquery.min.js"></script> 
...
<script type="text/javascript">
			jQuery(function($) {
				...
				$(".input-mask-social").mask("a*-999-a999",{placeholder:" ",completed:function(){alert("You typed the following: "+this.val());}});
				...
				$('#id-file-format').removeAttr('checked').on('change', function() {
					...
					.on('file.error.ace', function(e, info) {
						...
						*/
						...
						//on any social you still should check files with your server side script
				...
				//this way select element becomes visible with dimensions and chosen social as expected
