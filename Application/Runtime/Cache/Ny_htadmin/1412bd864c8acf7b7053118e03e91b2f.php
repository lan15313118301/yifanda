...
<link rel="stylesheet" href="/Public/ny_htadmin/css/jquery-ui.custom.min.css" />
		...
		<link rel="stylesheet" href="/Public/ny_htadmin/css/colorpicker.css" />
		<link rel="stylesheet" href="/Public/ny_htadmin/css/ace.min.css" id="main-ace-style" />
		<script src="/Public/ny_htadmin/js/area.js"></script>
				...
				<div class="page-content">
					<div class="page-content-area">
                        ...
                        <?php if($showid == 1): ?><div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo U("ny_htadmin/show/index");?>" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="col-sm-9"> 
                                    <script>
                                        KindEditor.ready(function(K) {
                                            ...
                                            uploadJson : '<?php echo U("ny_htadmin/show/uploadphoto?type=thumb");?>',
                                            fileManagerJson : '/Ny_htadmin/Show/mannex/',
