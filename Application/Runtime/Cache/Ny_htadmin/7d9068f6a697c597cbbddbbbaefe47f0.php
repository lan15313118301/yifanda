...
<html>
	<head>
		...
		<link rel="stylesheet" href="/Public/ny_htadmin/css/ace.min.css" />
		<!--[if lte IE 9]>
		...
		<!--[if lt IE 9]>
		<script src="/Public/ny_htadmin/js/html5shiv.js"></script>
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
                                	<img src="/Public/ny_htadmin/images/logo_bot.png">
								</h1>
							</div>
										...
										<div class="widget-main">
											...
											<form action="" method="post" id="myform">
												<fieldset>
                                                    ...
                                                    <label class="block clearfix">
														<span class="block input-icon input-icon-right">
                                                            <img src="<?php echo U("ny_htadmin/login/verify");?>" onclick="this.src=this.src+'?'+Math.random()" title="点击更换" />
														</span>
													</label>
