...
<div class="main-container" id="main-container">
  ...
  <ul class="nav nav-list" style="top: 0px;">
    ...
    <li class="<?php if(CONTROLLER_NAME == 'Show' && $type == '1' || CONTROLLER_NAME == 'Qualification' || CONTROLLER_NAME == 'Honor' || CONTROLLER_NAME == 'Social'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 企业概况 </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
        <ul class="submenu">
          <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '1') echo "class='active'"; ?>><a href="<?php echo U("zr_htadmin/show/index?id=1");?>"><i class="menu-icon fa fa-caret-right"></i>公司介绍</a><b class="arrow"></b>
          </li>
          <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '2') echo "class='active'"; ?>><a href="<?php echo U("zr_htadmin/show/index?id=2");?>"><i class="menu-icon fa fa-caret-right"></i>组织架构</a><b class="arrow"></b>
          </li>
          <li <?php if(CONTROLLER_NAME == 'Qualification') echo "class='active'"; ?>><a href="<?php echo U("zr_htadmin/qualification/index");?>"><i class="menu-icon fa fa-caret-right"></i>企业资质</a><b class="arrow"></b>
          </li>
          <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '3') echo "class='active'"; ?>><a href="<?php echo U("zr_htadmin/show/index?id=3");?>"><i class="menu-icon fa fa-caret-right"></i>业绩分布图</a><b class="arrow"></b>
          </li>
          <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '4') echo "class='active'"; ?>><a href="<?php echo U("zr_htadmin/show/index?id=4");?>"><i class="menu-icon fa fa-caret-right"></i>业务结构</a><b class="arrow"></b>
          </li>
          <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '5') echo "class='active'"; ?>><a href="<?php echo U("zr_htadmin/show/index?id=5");?>"><i class="menu-icon fa fa-caret-right"></i>公司实力</a><b class="arrow"></b>
          </li>
          <li <?php if(CONTROLLER_NAME == 'Honor') echo "class='active'"; ?>><a href="<?php echo U("zr_htadmin/honor/index");?>"><i class="menu-icon fa fa-caret-right"></i>公司荣誉</a><b class="arrow"></b>
          </li>
          <li <?php if(CONTROLLER_NAME == 'Social') echo "class='active'"; ?>><a href="<?php echo U("zr_htadmin/social/index");?>"><i class="menu-icon fa fa-caret-right"></i>社会责任</a><b class="arrow"></b>
          </li>
        </ul>
    </li>
