...
<div class="main-container" id="main-container"> 
  ...
  <ul class="nav nav-list" style="top: 0px;">
    ...
    <li <?php if(CONTROLLER_NAME == 'Cooperation'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("zr_htadmin/cooperation/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 合作伙伴 </span> </a> <b class="arrow"></b>
    </li>
    ...
    <div class="page-content">
      <div class="page-content-area">
        ...
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="<?php echo U("zr_htadmin/cooperation/add");?>" method="post" enctype="multipart/form-data">
						...
						if(ext && /^(jpg|jpeg|png|gif)$/.test(ext)){
							...
							$("#thumbbutton").attr("disabled","disabled");
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Zr_htadmin/Cooperation/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
...
<script type="text/javascript">
			jQuery(function($) {
				...
				$(".input-mask-cooperation").mask("a*-999-a999",{placeholder:" ",completed:function(){alert("You typed the following: "+this.val());}});
				...
				$('#id-file-format').removeAttr('checked').on('change', function() {
					...
					.on('file.error.ace', function(e, info) {
						...
						*/
						...
						//on any cooperation you still should check files with your server side script
				...
				//this way select element becomes visible with dimensions and chosen cooperation as expected
