...
<link rel="stylesheet" href="/Public/zr_htadmin/css/colorpicker.css" />
<link rel="stylesheet" href="/Public/zr_htadmin/css/ace.min.css" id="main-ace-style" />
<script src="/Public/zr_htadmin/js/area.js"></script>
...
$(function(){
	 $("#class1").change(function(){	 
		 ...
		 //alert($lbtitle);
		 $.getJSON('<?php echo U("zr_htadmin/news/class2");?>',{lbtitle:$lbtitle},function(data){
		 if (data.status==1){
...
<div class="main-container" id="main-container"> 
  ...
  <ul class="nav nav-list" style="top: 0px;">
    ...
    <li <?php if(CONTROLLER_NAME == 'Industry'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("zr_htadmin/industry/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 行业应用 </span> </a> <b class="arrow"></b>
    </li>
    <li <?php if(CONTROLLER_NAME == 'Download'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("zr_htadmin/download/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 下载中心 </span> </a> <b class="arrow"></b>
    </li>
    ...
    <li <?php if(CONTROLLER_NAME == 'Message'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("zr_htadmin/message/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 客户留言 </span> </a> <b class="arrow"></b>
    </li>
    ...
    <li <?php if(CONTROLLER_NAME == 'Message'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("zr_htadmin/message/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 合作伙伴 </span> </a> <b class="arrow"></b>
    </li>
    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 新闻中心 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 修改 </small> </h1>
        </div>
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
             ...
             <div class="form-group">
                ...
                <div class="col-sm-9">
                  ...
                  <script src="/Public/zr_htadmin/js/jquery-1.7.1.min.js"></script> 
                  <script type="text/javascript" src="/Public/zr_htadmin/js/ajaxupload.3.6.js" ></script>
                  <input id="thumbbutton" class="btn btn-xs" type="button" value="重新上传" />
                  (尺寸 278*210)  
                  <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        new AjaxUpload('thumbbutton', { action : "<?php echo U('zr_htadmin/upload/upload?type=thumb');?>",//请求目标
                                                            name : 'upload', //文件参数名
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Zr_htadmin/News/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <link rel="stylesheet" href="/Public/zr_htadmin/kindeditor-4.1.10/themes/default/default.css" />
                  <link rel="stylesheet" href="/Public/zr_htadmin/kindeditor-4.1.10/plugins/code/prettify.css" />
                  <script charset="utf-8" src="/Public/zr_htadmin/kindeditor-4.1.10/kindeditor.js"></script> 
                  <script charset="utf-8" src="/Public/zr_htadmin/kindeditor-4.1.10/lang/zh_CN.js"></script> 
                  <script charset="utf-8" src="/Public/zr_htadmin/kindeditor-4.1.10/plugins/code/prettify.js"></script>
                  <style>
                  ...
                  <script>
                                                    KindEditor.ready(function(K) {
                                                            var editor1 = K.create('textarea[name="content"]', {
                                                                    cssPath : '/Public/zr_htadmin/kindeditor-4.1.10/plugins/code/prettify.css',
                //                                                    uploadJson : '/Public/zr_htadmin/kindeditor-4.1.10/php/upload_json.php',
                                                                    uploadJson : '<?php echo U("zr_htadmin/upload/uploadphoto?type=thumb");?>',
                                                                    fileManagerJson : '<?php echo U("zr_htadmin/upload/mannex");?>',
