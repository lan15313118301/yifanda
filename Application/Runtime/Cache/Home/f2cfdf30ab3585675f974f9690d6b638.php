...
<div class="header">
    ...
    <div class="head inner">
        ...
        <div class="ss">
            ...
            <div class="d">
            	热门：<a href="<?php echo ('tourism/index');?>">旅游服务</a>  |  <a href="<?php echo ('language/index');?>">外语翻译</a>  | <a href="<?php echo ('house/index');?>"> 家政服务</a>  |  <a href="<?php echo ('business/index');?>">商业信息咨询</a>  |  <a href="<?php echo ('law/index');?>">法律咨询服务</a>
            </div>
        </div>
...
<div class="ernavbg">
	<div class="ernav inner">
    	<div class="position">当前位置：<a href="/">首页</a> > <a href="<?php echo U("business/index");?>">外语翻译</a></div>
        <div class="nav">
        	<ul>
              <li class="hover"><a href="#title1">外语翻译</a></li>
            </ul>
        </div>
    </div>
</div>
