...
<div class="ernavbg">
	<div class="ernav inner">
    	<div class="position">当前位置：<a href="/">首页</a> > <a href="<?php echo U("news/index");?>">动态信息</a></div>
        <div class="nav">
        	<ul>
              <li <?php if($type == '1'): ?>class="hover"<?php endif; ?>><a href="<?php echo U("news/index?type=1");?>">企业动态</a></li>
              <li <?php if($type == '2'): ?>class="hover"<?php endif; ?>><a href="<?php echo U("news/index?type=2");?>">行业动态</a></li>
              <li class="hover"><a href="<?php echo U("news/video");?>">视频播报</a></li>
            </ul>
        </div>
    </div>
</div>
<div class="product inner">
	<ul>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
        	<a href="<?php echo U('news/show?id='.$v['id'].'');?>"><img src="<?php echo ($v["thumb"]); ?>">
