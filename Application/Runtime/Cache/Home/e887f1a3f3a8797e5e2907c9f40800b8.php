...
<section> 
  ...
  <div class="t-ctn b-ctn">
    <div class="bty">
		<img src="/Public/mobile/img/newsbg.jpg" width="640" height="202" alt="banner">
	</div>
    <ul>
        <li <?php if($type == 1): ?>class="hover"<?php endif; ?>><a href="<?php echo U('news/index?type=1');?>">行业新闻</a></li>
        </ul>
  </div>
...
<section> 
    <div class="content news_show">
    	<span class="t1"><?php echo ($data["name"]); ?></span>
        <span class="t2">作者：<?php echo ($data["author"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日期：<?php echo (date('Y-m-d',$data["addtime"])); ?></span>
    	<div class="cont"><?php echo ($data["content"]); ?></div>
        <div class="b">
        	<span class="l">
            上一篇：
            <?php if($down): ?><a href="<?php echo U('news/show?id='.$down['id'].'');?>"><?php echo ($down["name"]); ?></a>
            <?php else: ?>
            	没有了<?php endif; ?>
            </span>
        	<span class="r">
            下一篇：
            <?php if($up): ?><a href="<?php echo U('news/show?id='.$up['id'].'');?>"><?php echo ($up["name"]); ?></a>
            <?php else: ?>
            	没有了<?php endif; ?>
