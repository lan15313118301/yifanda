    ...
    <div class="content news">
    	<ul>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($i == 1): ?><li class="one">
                        ...
                        <p><?php echo (cut_str($v["summary"],60)); ?></p>
                        <a href="<?php echo U('news/show?id='.$v['id'].'');?>" class="more">阅读全文</a>
                    </li>
                <?php else: ?>
            		<li><a href="<?php echo U('news/show?id='.$v['id'].'');?>"><?php echo ($v["name"]); ?></a><span><?php echo (date('Y/m/d',$v["addtime"])); ?></span></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
