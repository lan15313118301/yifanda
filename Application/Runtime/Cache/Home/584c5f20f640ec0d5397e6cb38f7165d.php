...
<div class="service inner">
  <div class="erright">
    <div class="top">
      <div class="position"><a href="/">首页</a> > 加入我们</div>
    </div>
    <div class="content support"> 
      <div class="r" style="width:100%">
        <ul style="width:100%">
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li style="width:100%"> <span class="tit" style="width:100%"><?php echo ($v["name"]); ?></span>
            <div class="cont"> 
            	<p style="width:100%"><?php echo ($v["content"]); ?></p>
                <span style="float:left; width:100%; text-align:center; color:#328FD8; font-weight:bold; margin-top:50px">请将您的简历发送至：jkgfl@163.com<br>或拨打电话：010-56865716</span>
              <img src="/Public/home/img/top.jpg" style="margin-left:525px" />
              </div>
