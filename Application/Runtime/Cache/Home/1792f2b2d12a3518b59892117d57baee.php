...
<div class="service inner">
	<div class="ernav">
    	<span>客服服务</span>
        <ul>
        	<?php if(is_array($service)): $i = 0; $__LIST__ = $service;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li <?php if($v["id"] == $dataid): ?>class="hover"<?php endif; ?>><a href="<?php echo U('service/index?id='.$v['id'].'');?>"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
     ...
     <div class="erright">
    	<div class="top">
            ...
            <div class="position">
            	您当前位置：<a href="/">首页</a> > 
                <a href="<?php echo U('service/index');?>">客服服务</a> >
                <?php echo ($data["name"]); ?>
            </div>
        </div>
