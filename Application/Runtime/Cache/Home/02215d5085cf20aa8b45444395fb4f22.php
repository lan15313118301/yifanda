...
<section> 
  ...
  <div class="t-ctn b-ctn">
    ...
    <ul>
      <li <?php if($data["id"] == 1): ?>class="hover"<?php endif; ?>><a href="<?php echo U('aboutus/index');?>">公司介绍</a>
      </li>
      <li <?php if($data["id"] == 2): ?>class="hover"<?php endif; ?>><a href="<?php echo U('aboutus/honor');?>">望海荣誉</a>
      </li>
      <li <?php if(ACTION_NAME == 'style' || ACTION_NAME == 'style_show'): ?>class="hover"<?php endif; ?>><a href="<?php echo U('aboutus/style');?>">望海风采</a>
      </li>
      <li <?php if($data["id"] == 3): ?>class="hover"<?php endif; ?>><a href="<?php echo U('aboutus/speech');?>">总裁致辞</a>
      </li>
    </ul>
  </div>
</section>
<section> 
  ...
  <div class="t-ctn t-ctn2 b-ctn3">
    <h3> <a> 望海风采 </a> </h3>
    <!--标题-->
    <div class="bty2 content">
      <h1 style="display: none;" id="Slidedown_SlideBanner"></h1>
      <div class="viewport" style="width: 620px;  margin-bottom:20px">
        <div class="flipsnap bannerControl"> 
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="item"><a data-transition="flip"><img data-original="" src="<?php echo ($v["thumb"]); ?>" style=" width:620px" alt="" title="" class="lazy" ></a></div><?php endforeach; endif; else: echo "" ;endif; ?> 
