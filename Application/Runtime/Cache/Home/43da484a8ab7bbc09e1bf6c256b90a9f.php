...
<section> 
  ...
  <div class="t-ctn b-ctn">
    <h3 style="font-size:30px">电力服务</h3>
    <div class="bty"> <img src="/Public/mobile/img/powerbg.jpg" width="640" height="202" alt="banner"> </div>
    <ul>
      <li class="hover"><a href="<?php echo U("power/index");?>">电力项目</a></li>
    </ul>
...
<section> 
  ...
  <div class="photovoltaic">
    <div class="content">
            <ul>
            	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('power/show?id='.$v['id'].'');?>"><img src="<?php echo ($v["thumb"]); ?>"><span><?php echo ($v["name"]); ?></span><span>项目进展：<?php echo ($v["name1"]); ?></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
