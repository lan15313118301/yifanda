...
<div class="ernavbg">
    ...
    <div class="nav">
    	<ul>
              <li class="hover"><a href="<?php echo U("cooperative/index");?>">合作伙伴</a></li>
            </ul>
           </div> 
    	<div class="position">当前位置:<a href="/">首页</a> > <a href="<?php echo U("cooperative/index");?>">合作伙伴</a></div>
    </div>
</div>
<div class="cooperative_show inner"> 
	<div class="content">
