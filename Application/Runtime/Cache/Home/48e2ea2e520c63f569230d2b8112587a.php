...
<div class="ernavbg">
	<div class="ernav inner">
    	<div class="position">当前位置：<a href="/">首页</a> > <a href="<?php echo U("case/more");?>">产品展示</a> > 
        <?php if($data["type"] == '1'): ?><a href="<?php echo U('case/more?type=1');?>">TDL柔性饰面砖</a><?php endif; ?>
		<?php if($data["type"] == '2'): ?><a href="<?php echo U('case/more?type=2');?>">TDL天然彩色装饰砂浆</a><?php endif; ?>
		<?php if($data["type"] == '3'): ?><a href="<?php echo U('case/more?type=3');?>">TDL外墙外保温</a><?php endif; ?>
        > <?php echo ($data["name"]); ?>
        </div>
        <div class="nav">
        	<ul>
              <li <?php if($data["type"] == '1'): ?>class="hover"<?php endif; ?>><a href="<?php echo U('case/more?type=1');?>">TDL柔性饰面砖</a></li>
              <li <?php if($data["type"] == '2'): ?>class="hover"<?php endif; ?>><a href="<?php echo U('case/more?type=2');?>">TDL天然彩色装饰砂浆</a></li>
              <li <?php if($data["type"] == '3'): ?>class="hover"<?php endif; ?>><a href="<?php echo U('case/more?type=3');?>">TDL外墙外保温</a></li>
            </ul>
        </div>
    </div>
</div>
<div class="news_show inner"> 
	<div class="content">
        ...
        <span class="title1" style="line-height:44px; float:left; width:100%; text-align:center; font-size:14px">发布时间：<?php echo (date('Y-m-d',$data["addtime"])); ?></span>
    	<div class="con">
