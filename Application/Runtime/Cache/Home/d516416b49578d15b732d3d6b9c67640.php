...
<div class="furniture inner">
  <div class="erright" style="width:1200px">
    <div class="top" style="width:1200px"> <span>清明家具</span>
      <div class="position"> 您当前位置：<a href="/">首页</a> > <a href="<?php echo U('furniture/index');?>">清明家具</a> > <a href="<?php echo U('furniture/index?type='.$data["type"].'');?>"><?php echo (furnituretype($data["type"])); ?></a> > <?php echo ($data["name"]); ?> </div>
    </div>
    <div class="furniture_show">
    	<div class="up">
        	<div class="l">
            	<div id=preview>
                	<SCRIPT src="/Public/home/js/jquery-1.2.6.pack.js" type=text/javascript></SCRIPT>
                	<SCRIPT src="/Public/home/js/niutuku.base.js" type=text/javascript></SCRIPT>
                    <div class=jqzoom id=spec-n1>
                    <IMG src="<?php echo ($imgs["0"]); ?>" jqimg="<?php echo ($imgs["0"]); ?>" width="600" height="400">
                    </div>
                    <div id=spec-n5>
                        <div class=control id=spec-left>
                        </div>
                        <div id=spec-list>
                            <ul class=list-h style="padding-left:26px">
                            	<?php if(is_array($imgs)): $i = 0; $__LIST__ = $imgs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><img src="<?php echo ($v); ?>"> </li><?php endforeach; endif; else: echo "" ;endif; ?>
                                <?php if(is_array($imgs)): $i = 0; $__LIST__ = $imgs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><img src="<?php echo ($v); ?>"> </li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                        </div>
...
//							});
				...
				<SCRIPT src="/Public/home/js/niutuku.lib.js" type=text/javascript></SCRIPT>
				<SCRIPT src="/Public/home/js/niutuku.js" type=text/javascript></SCRIPT>
            </div>
            <div class="r">
            	<span class="t"><?php echo ($data["name"]); ?></span>
                <ul>
                	<li><span>官网价格：</span><font>¥ <?php echo ($data["price"]); ?> </font>元
                	<li><span>品　　牌：</span><?php echo ($data["brand"]); ?>
                	<li><span>产品系列：</span><?php echo ($data["series"]); ?>
                	<li><span>产品风格：</span><?php echo ($data["style"]); ?>
                	<li><span>产品型号：</span><?php echo ($data["model"]); ?>
                	<li><span>产品主材：</span><?php echo ($data["material"]); ?>
                	<li><span>产品尺寸：</span><?php echo ($data["size"]); ?>
                	<li><span>服　　务：</span><?php echo ($data["service"]); ?></li>
                </ul>
                <span class="tel">电话咨询：0769-88771001</span>
                <a href="" class="yy">预约体验</a>
                <img src="/Public/home/img/furnitureewm.gif" class="ewm">
            </div>
        </div>
        <div class="down">
        	<SCRIPT type=text/javascript>
				$(function(){			
					$("#twan").click(function(){
						$(this).addClass("hover");
				  		$("#csan").removeClass("hover");
						$("#tw").show();
						$("#cs").hide();
				 	});	
					$("#csan").click(function(){
						$(this).addClass("hover");
				  		$("#twan").removeClass("hover");
				  		$("#tw").hide();
						$("#cs").show();
				 	});		
				})
        	...
        	<div class="t">
            	<span class="hover" id="twan">图文介绍</span>
	            <span id="csan">商品参数</span>
            </div>
        	<div class="cont" id="tw">
            	<?php echo ($data["content"]["0"]); ?>
            </div>
            <div class="cont" id="cs" style="display:none">
