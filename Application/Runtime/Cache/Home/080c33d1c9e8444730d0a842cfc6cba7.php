...
<div class="ernavbg">
	<div class="ernav inner">
    	<div class="position">
        	当前位置:<a href="/">首页</a> > <a href="<?php echo U("technical/index");?>">技术解答</a>
            > <?php echo ($data["name"]); ?>
        </div>
        <div class="nav">
        	<ul>
...
<div class="news_show inner"> 
	<div class="content">
        ...
        <span class="title1" style="line-height:44px; float:left; width:100%; text-align:center; font-size:14px">来源：<?php echo ($data["author"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发布时间：<?php echo (date('Y-m-d',$data["addtime"])); ?></span>
    	<div class="con">
