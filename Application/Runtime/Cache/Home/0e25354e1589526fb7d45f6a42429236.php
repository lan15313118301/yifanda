...
<section>
  <div class="content support">
    <ul>
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li> <a href="<?php echo U('support/show?id='.$v['id'].'');?>"><img src="<?php echo ($v["thumb"]); ?>"></a> <span class="t"><a href="<?php echo U('support/show?id='.$v['id'].'');?>"><?php echo (cut_str($v["name"],12)); ?></a> <font></font></span>
        <p><?php echo (cut_str($v["summary"],80)); ?></p>
        <a href="<?php echo U('support/show?id='.$v['id'].'');?>"><span class="t2">查看详情</span></a> </li><?php endforeach; endif; else: echo "" ;endif; ?>
