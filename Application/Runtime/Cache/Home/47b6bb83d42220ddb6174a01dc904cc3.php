...
<div class="header">
    ...
    <div class="head inner">
        ...
        <div class="ss">
            ...
            <div class="d">
            	热门：<a href="<?php echo ('tourism/index');?>">旅游服务</a>  |  <a href="<?php echo ('tourism/index');?>">外语翻译</a>  | <a href="<?php echo ('tourism/index');?>"> 家政服务</a>  |  <a href="<?php echo ('tourism/index');?>">商业信息咨询</a>  |  <a href="<?php echo ('tourism/index');?>">法律咨询服务</a>
            </div>
        </div>
...
<div class="ernavbg">
	<div class="ernav inner">
    	<div class="position">当前位置：<a href="/">首页</a> > <a href="<?php echo U("law/index");?>">法律咨询服务</a></div>
        <div class="nav">
        	<ul>
...
<div class="news inner">
	<ul>
    	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
        	<a href="<?php echo U('law/show?id='.$v['id'].'');?>"><img src="<?php echo ($v["thumb"]); ?>"></a>
            <span><a href="<?php echo U('law/show?id='.$v['id'].'');?>"><?php echo ($v["name"]); ?></a></span>
            <p><?php echo (cut_str($v["summary"],200)); ?></p>
            <a href="<?php echo U('law/show?id='.$v['id'].'');?>" class="show">查看详情</a>
