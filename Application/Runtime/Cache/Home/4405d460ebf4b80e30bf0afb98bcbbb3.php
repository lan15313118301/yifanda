...
<div class="news inner">
  ...
  <div class="erright">
    <div class="top"> <span>下载中心</span>
      <div class="position">当前位置：<a href="/">首页</a> > 下载中心</div>
    </div>
    <div class="content">
      <ul>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('download/show?id='.$v['id'].'');?>"><?php echo ($v["name"]); ?></a><span class="time"><?php echo (date('Y/m/d',$v["addtime"])); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
