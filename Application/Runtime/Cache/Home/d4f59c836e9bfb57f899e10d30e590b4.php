...
<div class="furniture inner">
	<div class="ernav">
    	<span>明清家具</span>
        <ul>
        	<?php if(is_array($furnituretype)): $i = 0; $__LIST__ = $furnituretype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li <?php if($v["id"] == $type): ?>class="hover"<?php endif; ?>><a href="<?php echo U('furniture/index?type='.$v['id'].'');?>"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>        	
        </ul>
     ...
     <div class="erright">
    	<div class="top">
        	<span><?php if($type): echo (furnituretype($type)); else: ?>清明家具<?php endif; ?></span>
            <div class="position">
            	
            	您当前位置：<a href="/">首页</a> > 
                <a href="<?php echo U('furniture/index');?>">清明家具</a> 
                <?php if($type): ?>> <?php echo (furnituretype($type)); endif; ?>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                	<a href="<?php echo U('furniture/show?id='.$v['id'].'');?>"><img src="<?php echo ($v["thumb"]); ?>" class="img" /></a>
                    <span><?php echo (cut_str($v["name"],14)); ?><a href="<?php echo U('furniture/show?id='.$v['id'].'');?>" class="xx"><img src="/Public/home/img/more.png"></a></span>
