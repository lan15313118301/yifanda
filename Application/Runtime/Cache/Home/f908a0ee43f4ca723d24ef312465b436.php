...
<section> 
  ...
  <div class="t-ctn b-ctn">
    <h3>案例赏析</h3>
    <div class="bty"> <img src="/Public/mobile/img/productbg.jpg" width="640" height="202" alt="banner"> </div>
    <ul>
      <li <?php if($type == '1'): ?>class="on"<?php endif; ?>><a href="<?php echo U("case/index?type=1");?>">案例赏析</a>
      </li>
    </ul>
  </div>
</section>
<section>
  <div class="content case">
    <ul>
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li> <a href="<?php echo U('case/show?id='.$v['id'].'');?>"><img src="<?php echo ($v["thumb"]); ?>" alt="" title="" width="289" height="358"></a> <span><a  href="<?php echo U('case/show?id='.$v['id'].'');?>"><?php echo ($v["name"]); ?></a></span> </li><?php endforeach; endif; else: echo "" ;endif; ?>
