...
<div class="honor inner">
  ...
  <div class="erright">
    <div class="top"> <span>企业资质</span>
      <div class="position">当前位置：<a href="/">首页</a> > <a href="<?php echo U("aboutus/index");?>">企业概况</a> > 荣誉资质</div>
    </div>
    <div class="content">
    	<ul>
        	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
            	<a href="<?php echo U('aboutus/qualification_show?id='.$v['id'].'');?>">
