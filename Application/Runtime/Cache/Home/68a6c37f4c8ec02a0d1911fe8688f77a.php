...
<div class="craftsmanbg"></div>
<div style="clear:both"></div>
<div class="craftsman inner">
  <ul>
  	<?php if(is_array($craftsman)): $i = 0; $__LIST__ = $craftsman;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="li">
      <div class="t">
        <div class="l">
          <div id=preview> 
            <div class=jqzoom id=spec-n1<?php echo ($i); ?>> <IMG src="<?php echo ($v["img"]["0"]); ?>" jqimg="<?php echo ($v["img"]["0"]); ?>" width="375" height="413"> </div>
            <div id=spec-n5>
              <div id=spec-list<?php echo ($i); ?>  class="spec-list">
                <ul class=list-h style="padding-left:26px">
                	<?php for($x=0;$x<count($v[img]);$x++){ ?>
                 		<li><img src="<?php echo $v[img][$x] ?>"></li>
                    <?php } ?>
                </ul>
              </div>
            </div>
          ...
          <SCRIPT type=text/javascript>
					$(function(){			
						...
						$("#spec-list<?php echo ($i); ?>").jdMarquee({
							deriction:"left",
							width:405,
							height:72,
							step:1,
							...
							delay:10,
							control:true,
							_front:"#spec-right<?php echo ($i); ?>",
							_back:"#spec-left<?php echo ($i); ?>"
						});
						$("#spec-list<?php echo ($i); ?> img").bind("mouseover",function(){
							var src=$(this).attr("src");
							$("#spec-n1<?php echo ($i); ?> img").eq(0).attr({
      ...
      <div class="d">
      	<ul class="hiSlider hiSlider2">
            ...
            <?php for($x=0;$x<count($v[price]);$x++){ ?>
                 	<li class="hiSlider-item"><img src="<?php echo $v[price][$i] ?>" width="1200" height="375"></li>
			<?php } ?>
