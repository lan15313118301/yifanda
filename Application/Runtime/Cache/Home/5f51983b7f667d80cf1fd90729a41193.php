...
<div class="story inner">
	<div class="ernav">
    	<span>品牌故事</span>
        <ul>
        	<?php if(is_array($storytype)): $i = 0; $__LIST__ = $storytype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li <?php if($v["id"] == $type): ?>class="hover"<?php endif; ?>><a href="<?php echo U('story/index?type='.$v['id'].'');?>"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
     ...
     <div class="erright">
    	<div class="top">
        	<span><?php if($type): echo (storytype($type)); else: ?>品牌故事<?php endif; ?></span>
            <div class="position">
            	
            	您当前位置：<a href="/">首页</a> > 
                <a href="<?php echo U('story/index');?>">品牌故事</a>
                <?php if($type): ?>> <?php echo (storytype($type)); endif; ?>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                	<a href="<?php echo U('story/show?id='.$v['id'].'');?>"><img src="<?php echo ($v["thumb"]); ?>" class="img" /></a>
                    <span><a href="<?php echo U('story/show?id='.$v['id'].'');?>"><?php echo ($v["name"]); ?></a></span>
                    <p><?php echo ($v["summary"]); ?></p>
