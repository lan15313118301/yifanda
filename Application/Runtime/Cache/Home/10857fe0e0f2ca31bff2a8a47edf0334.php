...
<ul>            
  ...
  <div class="erright">
    <div class="top"> <span>解决方案</span>
      <div class="position"> 您当前位置：<a href="/">首页</a> > <a href="<?php echo U('product/programme');?>">解决方案</a></div>
    </div>
    ...
    <div class="content" style="min-height:700px;">
      <ul>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li> <a href="<?php echo U('product/shows?id='.$v['id'].'');?>"><img src="<?php echo ($v["thumb"]); ?>"></a>
              <div> <span class="hua"><font>+</font></span> <span class="tit"><a href="<?php echo U('product/shows?id='.$v['id'].'');?>"><?php echo ($v["name"]); ?></a></span>
                <p><?php echo ($v["summary"]); ?></p>
                <span class="time"><a href="<?php echo U('product/shows?id='.$v['id'].'');?>">查看详情</a></span> </div>
