     ...
     <div class="erright">
    	<div class="top">
            <div class="position">
                ...
                <?php if($data["type"] == 1): ?>> <a href="<?php echo U('healthy/index?type=1');?>">护鼻</a><?php endif; ?>
                <?php if($data["type"] == 2): ?>> <a href="<?php echo U('healthy/index?type=2');?>">爱眼</a><?php endif; ?>
                > <?php echo ($data["name"]); ?>
            </div>
        </div>
        ...
        <div class="content">
        	<div class="l">
            	<span>健康攻略</span>
                <ul>
                	<li <?php if($data["type"] == 1): ?>class="hover"<?php endif; ?>><a href="<?php echo U('healthy/index?type=1');?>">· 护鼻</a></li>
                    <li <?php if($data["type"] == 2): ?>class="hover"<?php endif; ?>><a href="<?php echo U('healthy/index?type=2');?>">· 爱眼</a></li>
                </ul>
            </div>
            <div class="r">
