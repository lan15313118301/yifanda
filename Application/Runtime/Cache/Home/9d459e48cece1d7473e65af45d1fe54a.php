...
<div class="support inner">
	<ul>
    	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                <a href="<?php echo U('project/show?id='.$v['id'].'');?>"><img src="<?php echo ($v["thumb"]); ?>"></a>
                <span class="t"><a href="<?php echo U('project/show?id='.$v['id'].'');?>"><?php echo ($v["name"]); ?></a> <font></font></span>
                <p>
                	<?php echo ($v["summary"]); ?><br>
					<b>使用型号：</b> <?php echo ($v["xinghao"]); ?><br>
                    <b>用水情况：</b> <?php echo ($v["qingkuang"]); ?><br>
                    <b>备　　注：</b> <?php echo ($v["beizhu"]); ?></b>
                    
                </p>
                <a href="<?php echo U('project/show?id='.$v['id'].'');?>"><span class="t2">查看详情</span></a>
