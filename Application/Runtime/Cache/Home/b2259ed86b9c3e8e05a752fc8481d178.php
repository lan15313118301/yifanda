...
<div class="ernavbg">
	<div class="ernav inner">
    	<div class="position">当前位置：<a href="/">首页</a> > <a href="<?php echo U("product/index");?>">产品展示</a> > 
        ...
        <div class="nav">
        	<ul>
              <li <?php if($type == '1'): ?>class="hover"<?php endif; ?>><a href="<?php echo U('product/more?type=1');?>">TDL柔性饰面砖</a></li>
              <li <?php if($type == '2'): ?>class="hover"<?php endif; ?>><a href="<?php echo U('product/more?type=2');?>">TDL天然彩色装饰砂浆</a></li>
              <li <?php if($type == '3'): ?>class="hover"<?php endif; ?>><a href="<?php echo U('product/more?type=3');?>">TDL外墙外保温</a></li>
            </ul>
        </div>
    </div>
</div>
<div class="product inner">
	<ul>
    	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
        	<a href="<?php echo U('product/show?id='.$v['id'].'');?>"><img src="<?php echo ($v["thumb"]); ?>">
