    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 技术支持 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 添加 </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="<?php echo U("jc_htadmin/technical/add");?>" method="post" enctype="multipart/form-data">
						...
						if(ext && /^(jpg|jpeg|png|gif)$/.test(ext)){
							...
							$("#thumbbutton").attr("disabled","disabled");
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Jc_htadmin/Technical/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
...
<script type="text/javascript">
			jQuery(function($) {
				...
				$(".input-mask-technical").mask("a*-999-a999",{placeholder:" ",completed:function(){alert("You typed the following: "+this.val());}});
				...
				$('#id-file-format').removeAttr('checked').on('change', function() {
					...
					.on('file.error.ace', function(e, info) {
						...
						*/
						...
						//on any technical you still should check files with your server side script
				...
				//this way select element becomes visible with dimensions and chosen technical as expected
