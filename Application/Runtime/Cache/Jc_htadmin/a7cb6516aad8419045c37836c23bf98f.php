...
<link rel="stylesheet" href="/Public/jc_htadmin/css/colorpicker.css" />
<link rel="stylesheet" href="/Public/jc_htadmin/css/ace.min.css" id="main-ace-style" />
<script src="/Public/jc_htadmin/js/area.js"></script>
...
$(function(){
	 $("#class1").change(function(){	 
		 ...
		 //alert($lbtitle);
		 $.getJSON('<?php echo U("jc_htadmin/patent/class2");?>',{lbtitle:$lbtitle},function(data){
		 if (data.status==1){
...
<div class="main-container" id="main-container"> 
  ...
  <ul class="nav nav-list" style="top: 0px;">
    ...
    <li <?php if(CONTROLLER_NAME == 'Show' && $type == '5'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("jc_htadmin/show/index?id=5");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 联系我们 </span> </a> <b class="arrow"></b></li>
  </ul>
    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 专利标准 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 修改 </small> </h1>
        </div>
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="col-xs-10 col-sm-4" name="auther" value="<?php echo ($list["auther"]); ?>" />
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  ...
                  <script src="/Public/jc_htadmin/js/jquery-1.7.1.min.js"></script> 
                  <script type="text/javascript" src="/Public/jc_htadmin/js/ajaxupload.3.6.js" ></script>
                  <input id="thumbbutton" class="btn btn-xs" type="button" value="重新上传" />
                  (尺寸 219*326) 
                  <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        new AjaxUpload('thumbbutton', { action : "<?php echo U('jc_htadmin/upload/upload?type=thumb');?>",//请求目标
                                                            name : 'upload', //文件参数名
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Jc_htadmin/Patent/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <link rel="stylesheet" href="/Public/jc_htadmin/kindeditor-4.1.10/themes/default/default.css" />
                  <link rel="stylesheet" href="/Public/jc_htadmin/kindeditor-4.1.10/plugins/code/prettify.css" />
                  <script charset="utf-8" src="/Public/jc_htadmin/kindeditor-4.1.10/kindeditor.js"></script> 
                  <script charset="utf-8" src="/Public/jc_htadmin/kindeditor-4.1.10/lang/zh_CN.js"></script> 
                  <script charset="utf-8" src="/Public/jc_htadmin/kindeditor-4.1.10/plugins/code/prettify.js"></script>
                  <style>
                  ...
                  <script>
                                                    KindEditor.ready(function(K) {
                                                            var editor1 = K.create('textarea[name="content"]', {
                                                                    cssPath : '/Public/jc_htadmin/kindeditor-4.1.10/plugins/code/prettify.css',
                //                                                    uploadJson : '/Public/jc_htadmin/kindeditor-4.1.10/php/upload_json.php',
                                                                    uploadJson : '<?php echo U("jc_htadmin/upload/uploadphoto?type=thumb");?>',
                                                                    fileManagerJson : '<?php echo U("jc_htadmin/upload/mannex");?>',
...
<!--[if lte IE 8]>
		  <script src="/Public/jc_htadmin/js/excanvas.min.js"></script>
		<![endif]--> 
<script src="/Public/jc_htadmin/js/jquery-ui.custom.min.js"></script> 
<script src="/Public/jc_htadmin/js/jquery.ui.touch-punch.min.js"></script> 
<script src="/Public/jc_htadmin/js/chosen.jquery.min.js"></script> 
<script src="/Public/jc_htadmin/js/fuelux/fuelux.spinner.min.js"></script> 
<script src="/Public/jc_htadmin/js/date-time/bootstrap-datepicker.min.js"></script> 
<script src="/Public/jc_htadmin/js/date-time/bootstrap-timepicker.min.js"></script> 
<script src="/Public/jc_htadmin/js/date-time/moment.min.js"></script> 
<script src="/Public/jc_htadmin/js/date-time/daterangepicker.min.js"></script> 
<script src="/Public/jc_htadmin/js/date-time/bootstrap-datetimepicker.min.js"></script> 
<script src="/Public/jc_htadmin/js/bootstrap-colorpicker.min.js"></script> 
<script src="/Public/jc_htadmin/js/jquery.knob.min.js"></script> 
<script src="/Public/jc_htadmin/js/jquery.autosize.min.js"></script> 
<script src="/Public/jc_htadmin/js/jquery.inputlimiter.1.3.1.min.js"></script> 
<script src="/Public/jc_htadmin/js/jquery.maskedinput.min.js"></script> 
<script src="/Public/jc_htadmin/js/bootstrap-tag.min.js"></script> 
<script src="/Public/jc_htadmin/js/typeahead.jquery.min.js"></script> 
...
<script type="text/javascript">
			jQuery(function($) {
				...
				$(".input-mask-patent").mask("a*-999-a999",{placeholder:" ",completed:function(){alert("You typed the following: "+this.val());}});
				...
				$('#id-file-format').removeAttr('checked').on('change', function() {
					...
					.on('file.error.ace', function(e, info) {
						...
						*/
						...
						//on any patent you still should check files with your server side script
				...
				//this way select element becomes visible with dimensions and chosen patent as expected
