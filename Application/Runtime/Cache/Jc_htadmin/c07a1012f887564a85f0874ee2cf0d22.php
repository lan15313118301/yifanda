				...
				<div class="page-content">
					<div class="page-content-area">
                        ...
                        <?php if($showid == 1): ?><div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo U("jc_htadmin/show/index");?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> 企业介绍 : </label>
                                  <div class="col-sm-9"> 
                                    <script>
                                        KindEditor.ready(function(K) {
                                            var editor1 = K.create('textarea[name="content[]"]', {
                                            cssPath : '/Public/jc_htadmin/kindeditor-4.1.10/plugins/code/prettify.css',
                                            uploadJson : '<?php echo U("jc_htadmin/show/uploadphoto?type=thumb");?>',
                                            fileManagerJson : '/Jc_htadmin/Show/mannex/',
                                ...
                                <div class="space-4"></div>
                                <div class="form-group">
                                  <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> 标准规范 : </label>
                                  <div class="col-sm-9"> 
                                ...
                                <div class="space-4"></div>
                                <div class="form-group">
                                  <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> 竞争优势 : </label>
                                  <div class="col-sm-9"> 
									<textarea name="content[]" class="col-xs-10" style="height:360px;visibility:hidden;"><?php echo ($list["content"]["2"]); ?></textarea>
                                  </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                  <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> 企业精神 : </label>
                                  <div class="col-sm-9"> 
									<textarea name="content[]" class="col-xs-10" style="height:360px;visibility:hidden;"><?php echo ($list["content"]["3"]); ?></textarea>
                                  </div>
                                </div>
