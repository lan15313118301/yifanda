...
<div class="main-container" id="main-container"> 
  ...
  <ul class="nav nav-list" style="top: 0px;">
    ...
    <li class="<?php if(CONTROLLER_NAME == 'Show' && $type == '1' || CONTROLLER_NAME == 'Style'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 关于望海 </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
    <ul class="submenu">
      ...
      <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '2') echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/show/index?id=2");?>"><i class="menu-icon fa fa-caret-right"></i>望海荣誉</a><b class="arrow"></b></li>
      <li <?php if(CONTROLLER_NAME == 'Style') echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/style/index");?>"><i class="menu-icon fa fa-caret-right"></i>望海风采</a><b class="arrow"></b></li>
      <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '3') echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/show/index?id=3");?>"><i class="menu-icon fa fa-caret-right"></i>总裁致辞</a><b class="arrow"></b></li>
    </ul>
    </li>
    
    <li class="<?php if(CONTROLLER_NAME == 'Product'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 产品合作 </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
    <ul class="submenu">
    ...
    <ul class="submenu">
      <li class="<?php if(CONTROLLER_NAME == 'Programme'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-caret-right"></i> 游戏发行商 <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
        <ul class="submenu">
    		<li <?php if($type == 1) echo 'class="active"'; ?> > <a href="<?php echo U("dr_htadmin/programme/index?type=1");?>"> 游戏发行商</a> <b class="arrow"></b> </li>
            <li <?php if($type == 2) echo 'class="active"'; ?> > <a href="<?php echo U("dr_htadmin/programme/index?type=2");?>"> DRG</a> <b class="arrow"></b> </li>
            <li <?php if($type == 3) echo 'class="active"'; ?> > <a href="<?php echo U("dr_htadmin/programme/index?type=3");?>"> HRP</a> <b class="arrow"></b> </li>
            
        </ul>
      </li> 
      <li class="<?php if(CONTROLLER_NAME == 'Case'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-caret-right"></i> 经典案例 <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
        <ul class="submenu">
          	<li <?php if($type == 1) echo 'class="active"'; ?> > <a href="<?php echo U("dr_htadmin/case/index?type=1");?>"> 西北地区</a> <b class="arrow"></b> </li>
            <li <?php if($type == 2) echo 'class="active"'; ?> > <a href="<?php echo U("dr_htadmin/case/index?type=2");?>"> 东北地区</a> <b class="arrow"></b> </li>
            <li <?php if($type == 3) echo 'class="active"'; ?> > <a href="<?php echo U("dr_htadmin/case/index?type=3");?>"> 华东地区</a> <b class="arrow"></b> </li>
            <li <?php if($type == 4) echo 'class="active"'; ?> > <a href="<?php echo U("dr_htadmin/case/index?type=4");?>"> 西南地区</a> <b class="arrow"></b> </li>
            <li <?php if($type == 5) echo 'class="active"'; ?> > <a href="<?php echo U("dr_htadmin/case/index?type=5");?>"> 华北地区</a> <b class="arrow"></b> </li>
            <li <?php if($type == 6) echo 'class="active"'; ?> > <a href="<?php echo U("dr_htadmin/case/index?type=6");?>"> 华南地区</a> <b class="arrow"></b> </li>
            <li <?php if($type == 7) echo 'class="active"'; ?> > <a href="<?php echo U("dr_htadmin/case/index?type=7");?>"> 华中地区</a> <b class="arrow"></b> </li>
    ...
    <li class="<?php if(CONTROLLER_NAME == 'Show' && $type == '2'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 咨询服务 </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
    <ul class="submenu">
      <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '4') echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/show/index?id=4");?>"><i class="menu-icon fa fa-caret-right"></i>实施服务</a><b class="arrow"></b></li>
      <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '5') echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/show/index?id=5");?>"><i class="menu-icon fa fa-caret-right"></i>售前咨询</a><b class="arrow"></b></li>
    </ul>
    </li>
    ...
    <ul class="submenu">
      ...
      <li <?php if($type == 2) echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/news/index?type=2");?>"><i class="menu-icon fa fa-caret-right"></i>公司新闻</a><b class="arrow"></b></li>
      <li <?php if($type == 3) echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/news/index?type=3");?>"><i class="menu-icon fa fa-caret-right"></i>媒体报道</a><b class="arrow"></b></li>
    </ul>
    </li>
   
    <li class="<?php if(CONTROLLER_NAME == 'Show' && $type == '3'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 社会责任 </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
    <ul class="submenu">
      <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '6') echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/show/index?id=6");?>"><i class="menu-icon fa fa-caret-right"></i>公益理念</a><b class="arrow"></b></li>
      <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '7') echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/show/index?id=7");?>"><i class="menu-icon fa fa-caret-right"></i>慈善捐赠</a><b class="arrow"></b></li>
      <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '8') echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/show/index?id=8");?>"><i class="menu-icon fa fa-caret-right"></i>责任体系</a><b class="arrow"></b></li>
      <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '9') echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/show/index?id=9");?>"><i class="menu-icon fa fa-caret-right"></i>社会责任报告</a><b class="arrow"></b></li>
    </ul>
    </li>
    <li class="<?php if(CONTROLLER_NAME == 'Show' && $type == '4' || CONTROLLER_NAME == 'Careers'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 联系我们 </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
    <ul class="submenu">
<!--      <li <?php if(CONTROLLER_NAME == 'Show' && $showid == '1') echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/show/index?id=1");?>"><i class="menu-icon fa fa-caret-right"></i>公司介绍</a><b class="arrow"></b></li>-->
    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 经典案例 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 添加 </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="<?php echo U("dr_htadmin/case/add");?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  ...
                  <script src="/Public/dr_htadmin/js/jquery-1.7.1.min.js"></script> 
                  ...
                  <script type="text/javascript">
					$(document).ready(function() {
						new AjaxUpload('thumbbutton', { action : "<?php echo U('dr_htadmin/upload/upload?type=thumb');?>",//请求目标
						name : 'upload', //文件参数名
						...
						if(ext && /^(jpg|jpeg|png|gif)$/.test(ext)){
							...
							$("#thumbbutton").attr("disabled","disabled");
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Dr_htadmin/Case/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
              ...
              <div class="form-group">
                ...
                //                                                    uploadJson : '/Public/dr_htadmin/kindeditor-4.1.10/php/upload_json.php',
                                                                    uploadJson : '<?php echo U("dr_htadmin/upload/uploadphoto?type=thumb");?>',
                                                                    fileManagerJson : '<?php echo U("dr_htadmin/upload/mannex");?>',
...
<!--[if lte IE 8]>
		  <script src="/Public/dr_htadmin/js/excanvas.min.js"></script>
		<![endif]--> 
<script src="/Public/dr_htadmin/js/jquery-ui.custom.min.js"></script> 
<script src="/Public/dr_htadmin/js/jquery.ui.touch-punch.min.js"></script> 
<script src="/Public/dr_htadmin/js/chosen.jquery.min.js"></script> 
<script src="/Public/dr_htadmin/js/fuelux/fuelux.spinner.min.js"></script> 
<script src="/Public/dr_htadmin/js/date-time/bootstrap-datepicker.min.js"></script> 
<script src="/Public/dr_htadmin/js/date-time/bootstrap-timepicker.min.js"></script> 
<script src="/Public/dr_htadmin/js/date-time/moment.min.js"></script> 
<script src="/Public/dr_htadmin/js/date-time/daterangepicker.min.js"></script> 
<script src="/Public/dr_htadmin/js/date-time/bootstrap-datetimepicker.min.js"></script> 
<script src="/Public/dr_htadmin/js/bootstrap-colorpicker.min.js"></script> 
<script src="/Public/dr_htadmin/js/jquery.knob.min.js"></script> 
<script src="/Public/dr_htadmin/js/jquery.autosize.min.js"></script> 
<script src="/Public/dr_htadmin/js/jquery.inputlimiter.1.3.1.min.js"></script> 
<script src="/Public/dr_htadmin/js/jquery.maskedinput.min.js"></script> 
<script src="/Public/dr_htadmin/js/bootstrap-tag.min.js"></script> 
<script src="/Public/dr_htadmin/js/typeahead.jquery.min.js"></script> 
...
<script type="text/javascript">
			jQuery(function($) {
				...
				$(".input-mask-case").mask("a*-999-a999",{placeholder:" ",completed:function(){alert("You typed the following: "+this.val());}});
				...
				//this way select element becomes visible with dimensions and chosen case as expected
