...
<link rel="stylesheet" href="/Public/dr_htadmin/css/colorpicker.css" />
<link rel="stylesheet" href="/Public/dr_htadmin/css/ace.min.css" id="main-ace-style" />
<script src="/Public/dr_htadmin/js/area.js"></script>
...
$(function(){
	 $("#class1").change(function(){	 
		 ...
		 //alert($lbtitle);
		 $.getJSON('<?php echo U("dr_htadmin/style/class2");?>',{lbtitle:$lbtitle},function(data){
		 if (data.status==1){
...
<div class="main-container" id="main-container"> 
  ...
  <ul class="nav nav-list" style="top: 0px;">
    ...
    <ul class="submenu">
      <li <?php if(CONTROLLER_NAME == 'Furnituretype') echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/furnituretype/index");?>"><i class="menu-icon fa fa-caret-right"></i>栏目管理</a><b class="arrow"></b></li>
      <li class="<?php if(CONTROLLER_NAME == 'Furniture'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-caret-right"></i> 内容管理 <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
        <ul class="submenu">
          	<?php if(is_array($furnituretype)): $i = 0; $__LIST__ = $furnituretype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li <?php if($type == $v['id']) echo 'class="active"'; ?> > <a href="<?php echo U("dr_htadmin/furniture/index?type=".$v['id']."");?>"> <?php echo ($v["name"]); ?></a> <b class="arrow"></b> </li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
      </li> 
    </ul>
    </li>
    ...
    <ul class="submenu">
      <li <?php if(CONTROLLER_NAME == 'Customer'): ?>class='active'<?php endif; ?>><a href="<?php echo U("dr_htadmin/customer/index");?>"><i class="menu-icon fa fa-caret-right"></i>客户实录</a><b class="arrow"></b></li>
    </ul>
    </li>
    ...
    <ul class="submenu">
      <?php if(is_array($service)): $i = 0; $__LIST__ = $service;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li <?php if(CONTROLLER_NAME == 'Show' && $showid == $v['id']) echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/show/index?id=".$v['id']."");?>"><i class="menu-icon fa fa-caret-right"></i><?php echo ($v["name"]); ?></a><b class="arrow"></b></li><?php endforeach; endif; else: echo "" ;endif; ?>
      
    </ul>
    </li>
    
    <li <?php if(CONTROLLER_NAME == 'Craftsman'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("dr_htadmin/craftsman/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 工艺大师 </span> </a> <b class="arrow"></b></li>
    ...
    <ul class="submenu">
      <li <?php if(CONTROLLER_NAME == 'Storytype') echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/storytype/index");?>"><i class="menu-icon fa fa-caret-right"></i>栏目管理</a><b class="arrow"></b></li>
      <li class="<?php if(CONTROLLER_NAME == 'Story'): ?>active open<?php endif; ?> hsub"> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-caret-right"></i> 内容管理 <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
        <ul class="submenu">
          	<?php if(is_array($storytype)): $i = 0; $__LIST__ = $storytype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li <?php if($type == $v['id']) echo 'class="active"'; ?> > <a href="<?php echo U("dr_htadmin/story/index?type=".$v['id']."");?>"> <?php echo ($v["name"]); ?></a> <b class="arrow"></b> </li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
      </li> 
    </ul>
    </li>
    ...
    <ul class="submenu">
      <li <?php if($type == 1) echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/interlocution/index?type=1");?>"><i class="menu-icon fa fa-caret-right"></i>木材问答</a><b class="arrow"></b></li>
      <li <?php if($type == 2) echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/interlocution/index?type=2");?>"><i class="menu-icon fa fa-caret-right"></i>工艺问答</a><b class="arrow"></b></li>
      <li <?php if($type == 3) echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/interlocution/index?type=3");?>"><i class="menu-icon fa fa-caret-right"></i>搭配问答</a><b class="arrow"></b></li>
      <li <?php if($type == 4) echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/interlocution/index?type=4");?>"><i class="menu-icon fa fa-caret-right"></i>其它问答</a><b class="arrow"></b></li>
    </ul>
    </li>
    ...
    <ul class="submenu">
      <li <?php if($type == 1) echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/news/index?type=1");?>"><i class="menu-icon fa fa-caret-right"></i>公司动态</a><b class="arrow"></b></li>
      <li <?php if($type == 2) echo "class='active'"; ?>><a href="<?php echo U("dr_htadmin/news/index?type=2");?>"><i class="menu-icon fa fa-caret-right"></i>行业动态</a><b class="arrow"></b></li>
    </ul>
    </li>
   
    <li <?php if(CONTROLLER_NAME == 'Message'): ?>class="active"<?php endif; ?>> <a href="<?php echo U("dr_htadmin/message/index");?>"> <i class="menu-icon fa fa-file"></i> <span class="menu-text"> 留言管理 </span> </a> <b class="arrow"></b></li>
    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 望海风采 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 修改 </small> </h1>
        </div>
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
                  ...
                  <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        ...
                                                        $(".editthumb").live("click",function(){
                                                            ...
                                                            html += '<iframe width="100%" height="100%" src="/Dr_htadmin/Style/editthumb/thumb/'+$("#thumbshow img").attr("src").replace(/\//gm,"-").replace(/\./gm,"^")+'?'+Math.random()+'" id="HtmlEdit" style="border:0;"></iframe>';
                                                            html += '</div></div>';
                                                            $("body").append(html);
                                                        });
                                                    });
...
<script type="text/javascript">
			jQuery(function($) {
				...
				$(".input-mask-style").mask("a*-999-a999",{placeholder:" ",completed:function(){alert("You typed the following: "+this.val());}});
				...
				$('#id-file-format').removeAttr('checked').on('change', function() {
					...
					.on('file.error.ace', function(e, info) {
						...
						*/
						...
						//on any style you still should check files with your server side script
				...
				//this way select element becomes visible with dimensions and chosen style as expected
