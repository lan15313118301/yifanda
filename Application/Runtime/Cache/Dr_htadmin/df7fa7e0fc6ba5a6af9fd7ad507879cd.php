			...
			<div class="main-content">
				<div class="page-content">
					<div class="page-content-area">
                        ...
                        <?php if($type == 2): ?><div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo U("dr_htadmin/show/index");?>" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="col-sm-9"> 
                                    <script>
                                        KindEditor.ready(function(K) {
                                            ...
                                            uploadJson : '<?php echo U("dr_htadmin/show/uploadphoto?type=thumb");?>',
                                            fileManagerJson : '/Dr_htadmin/Show/mannex/',
