    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> 招贤纳士 <small> <i class="ace-icon fa fa-angle-double-right"></i> 内容管理 <i class="ace-icon fa fa-angle-double-right"></i> 添加 </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="<?php echo U("dr_htadmin/careers/add");?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> 职位要求 : </label>
                <div class="col-sm-9">
              ...
              <div class="space-4"></div>
              <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> 职位职责 : </label>
                <div class="col-sm-9">
                  <textarea class="col-xs-10 col-sm-5" id="form-field-8" name="content" ><?php echo ($list["content"]); ?></textarea>
                </div>
              </div>
...
<script type="text/javascript">
			jQuery(function($) {
				...
				$(".input-mask-careers").mask("a*-999-a999",{placeholder:" ",completed:function(){alert("You typed the following: "+this.val());}});
				...
				$('#id-file-format').removeAttr('checked').on('change', function() {
					...
					.on('file.error.ace', function(e, info) {
						...
						*/
						...
						//on any careers you still should check files with your server side script
				...
				//this way select element becomes visible with dimensions and chosen careers as expected
