...
class JoinusController extends BaseController {
    ...
    public function add(){
        ...
        if(I("post.action") == 'add'){
			...
			// dump($_REQUEST);
			if($joinus -> add($data))
			$this->success('添加成功', U('dr_htadmin/joinus/index?type='.I("type")));
            exit;
        }
        // dump($array);
		$array["type"] = I("type");
    ...
    public function edit(){
		...
		if(I("post.action") == 'edit'){
			...
			$this->success('保存成功', U('dr_htadmin/joinus/index?type='.I("type")));
			exit;
		}
    ...
    public function state(){
		...
		if($state == '0'){
			...
			if(M("joinus")-> where("id={$id}") -> save($data)){
				$this->success('操作成功', U('dr_htadmin/joinus/index?type='.I("type").''));
			}
		}
    ...
    public function del(){
            ...
            if($id > 0){
                ...
                $this->success('删除成功', ''.U('dr_htadmin/joinus/index').'');
            }else{
                $this->success('操作失败', ''.U('dr_htadmin/joinus/index').'');
            }
    }
    ...
    public function dels(){
            ...
            if($id > 0){
                ...
                $this->success('删除成功', U('dr_htadmin/joinus/index?type='.I("type").''));
            }else{
                $this->success('操作失败', U('dr_htadmin/joinus/index?type='.I("type").''));
            }
    }
