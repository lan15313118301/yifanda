...
class NewsController extends BaseController {
    ...
    public function index(){
        ...
        $array['list'] = $news->where("type=".I("type")."")->order("sort desc,id desc")->select();
    ...
    public function add(){
        ...
        if(I("post.action") == 'add'){
			...
			// dump($_REQUEST);
			if($news -> add($data))
			$this->success('添加成功', U('dr_htadmin/news/index?type='.I("type")));
            exit;
        }
        // dump($array);
		$array["type"] = I("type");
    ...
    public function edit(){
		...
		$array["list"] = $news->where("id=%d",array($id))->find();
		//保存修改
		if(I("post.action") == 'edit'){
			...
			// dump($data);
			$news->where("id=%d",array($id))->save($data);
			$this->success('保存成功', U('dr_htadmin/news/index?type='.I("type")));
			exit;
		}
